                ...
                <div className="flex gap-3 overflow-x-auto pb-2">
                  {productImages.map((img, idx) => (
                    <button
                      key={idx}
                      onClick={() => setSelectedImage(idx)}
                      className={`flex-shrink-0 w-20 h-20 rounded-xl overflow-hidden border-3 transition-all duration-300 hover:scale-105 ${selectedImage === idx
              ...
              <div className="sticky top-24">
                <div className="flex justify-between items-start">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {product.badge && (
                        <span className="inline-block bg-emerald-100 text-emerald-800 text-xs px-3 py-1 rounded-full font-medium ml-2">
                          {product.badge}
                        </span>
                      )}
                    </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-4 flex flex-wrap gap-4 text-sm text-gray-600">
                    ...
                    {product.category && (
                      <div className="flex items-center">
                        <TeaLeaf className="h-4 w-4 mr-1 text-emerald-600" />
                  ...
                  <div className="mt-3 flex flex-wrap gap-4 text-sm text-gray-600">
                    ...
                    {product.caffeineLevel && (
                      <div className="flex items-center">
                        <Coffee className="h-4 w-4 mr-1 text-emerald-600" />
                        <span>Caffeine: {product.caffeineLevel}</span>
                      </div>
                    )}
                    {product.weight && (
                      <div className="flex items-center">
                        <Scale className="h-4 w-4 mr-1 text-emerald-600" />
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-8">
                      <div className="flex items-center mb-6">
                        ...
                        <span className="ml-4 text-sm text-gray-500">Max 10</span>
                      </div>

                      <div className="flex flex-col sm:flex-row gap-4">
                        <button className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-6 rounded-lg font-medium flex items-center justify-center transition-colors">
                          <ShoppingCart className="h-5 w-5 mr-2" />
                          Add to Cart
                        </button>
                        <button className="flex-1 border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-50 py-3 px-6 rounded-lg font-medium flex items-center justify-center transition-colors">
                          Buy Now
                        </button>
                      </div>
                    </div>
